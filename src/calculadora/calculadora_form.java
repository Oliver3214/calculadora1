...
public class calculadora_form extends javax.swing.JFrame {
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        if (!memoria2.equals("")) {
            resultado= calculadora_form(memoria1, memoria2, signo);
            txtpantalla.setText(resultado);
        }
        
        
        //guardamos los datos que se insertan
        if (seleccionar.showDialog(null, "Guardar")==JFileChooser.APPROVE_OPTION) {
            archivo=seleccionar.getSelectedFile();
            if (archivo.getName().endsWith("txt")) {
                String documento =txtpantalla.getText();
    ...
    public static String calculadora_form(String memoria1, String memoria2, String signo){
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        //colocamos todos los datos del archivo
        ...
        if(seleccionar.showDialog(null, "Abrir")==JFileChooser.APPROVE_OPTION){
            ...
            if(archivo.canRead()){
                if(archivo.getName().endsWith("txt")){
                    ...
                    txthistorial.setText(documento);
